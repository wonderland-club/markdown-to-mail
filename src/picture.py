...
def making_tickets(in_time, in_period, interviewer_name):
    ...
    # 设置字体
    font_path = IMAGE_CONFIG['font_path']
    ...
    texts = [
        ...
        {"text": in_period, "position": (283, image.height - 586), "font": font_large},
        {"text": in_year, "position": (823, image.height - 219 ), "font": font_small},
        {"text": in_month, "position": (1013, image.height - 202), "font": font_small}
    ]
